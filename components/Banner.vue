  ...
  <div class="relative space-y-6">
    ...
    <div>
      ...
      >
        ...
        <div
          class="mb-12 mt-[64px] w-[85%] border-t h-[56px] flex text-white font-normal text-[16px] font-[inter,sans-serif] relative"
        >
          <p class="absolute bottom-0">© 2023 eCitizen. All rights reserved.</p>
          <div class="absolute bottom-0 right-0 flex gap-6">
